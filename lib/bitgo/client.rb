module Bitgo
  ...
  class Client
    ...
    def send_coins_to_address(wallet_id:, address:, amount:, walletPassphrase:, message: nil, minConfirms: nil, fee: nil, instant: false)
    ...
    def send_coins_to_multiple_addresses(wallet_id:, recipients:, walletPassphrase:, minConfirms: nil, fee: nil)
      params = {
    ...
    def list_wallet_transaction(wallet_id:)
      call :get, '/wallet/' + wallet_id + '/tx'
    end

    def get_wallet_transaction(wallet_id:, tx_id:)
